...
.news-sidebar-block--categories .news-sidebar-list li::before { background: #ffc928 !important; }
';
    wp_add_inline_style( 'twentytwenty-news-layout', $news_layout_inline_css );
...
function twentytwenty_register_scripts() {
	...
	// Enqueue account modal script
	wp_enqueue_script( 'twentytwenty-account-modal', get_template_directory_uri() . '/assets/js/account-modal.js', array(), $theme_version );
	wp_script_add_data( 'twentytwenty-account-modal', 'strategy', 'defer' );
}
...
function twentytwenty_sidebar_registration() {
	...
	register_sidebar( array(
		'name'          => __( 'Footer Widget 1', 'twentytwentyone' ),
		'id'            => 'footer-1',
	...
	register_sidebar( array(
		'name'          => __( 'Footer Widget 2', 'twentytwentyone' ),
		'id'            => 'footer-2',
		'description'   => __( 'Add widgets here to appear in your footer.', 'twentytwentyone' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget'  => '</div>',
	...
	register_sidebar( array(
		'name'          => __( 'Footer Widget 3', 'twentytwentyone' ),
		'id'            => 'footer-3',
		'description'   => __( 'Add widgets here to appear in your footer.', 'twentytwentyone' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget'  => '</div>',
	...
	register_sidebar( array(
		'name'          => __( 'Footer Widget 4', 'twentytwentyone' ),
		'id'            => 'footer-4',
		'description'   => __( 'Add widgets here to appear in your footer.', 'twentytwentyone' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget'  => '</div>',
